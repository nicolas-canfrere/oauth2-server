...
CREATE INDEX IF NOT EXISTS idx_audit_logs_event_type ON oauth_audit_logs (event_type);
CREATE INDEX IF NOT EXISTS idx_audit_logs_user_id ON oauth_audit_logs (user_id);
CREATE INDEX IF NOT EXISTS idx_audit_logs_client_id ON oauth_audit_logs (client_id);
CREATE INDEX IF NOT EXISTS idx_audit_logs_created_at ON oauth_audit_logs (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_audit_logs_level ON oauth_audit_logs (level);

-- Composite indexes for audit timeline queries
CREATE INDEX IF NOT EXISTS idx_audit_logs_user_timeline ON oauth_audit_logs (user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_audit_logs_client_activity ON oauth_audit_logs (client_id, created_at DESC);